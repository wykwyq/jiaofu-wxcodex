...
- Turn timeout: 5 minutes by default; override with `CODEXBRIDGE_TURN_TIMEOUT_MS`
- System proxy: set `CODEX_APP_RESPECT_SYSTEM_PROXY=1` when Codex HTTP checks pass but Responses WebSocket connections time out behind a Windows proxy
